...
if __name__ == '__main__':
    ...
    topo = pd.read_csv('/data/data/raw_data/topo.txt', sep='\t', names=['linkid', 'links'])
    ...
    train_files = sorted(os.listdir("/data/data/raw_data/traffic"))[-14:]
    for file in train_files:
        save2TFrecord("/data/data/raw_data/traffic", savePath, file)
